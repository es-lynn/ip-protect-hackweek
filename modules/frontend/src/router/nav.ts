...
export const nav = new (class {
  ...
  navigate<T extends object>(name: string, params?: T, screen?: string) {
  ...
  navigateAndPop<T extends object>(name: string, params?: T, screen?: string) {
  ...
  reset<T extends object>(name: string, params?: T, screen?: string) {
  ...
  push<T extends object>(name: string, params?: T) {
